  ...
  computed: {
    baseConfig() {
      return {
        ...
        list: {
          ...
          items: [
            ...
            // },
            {
              ...
              itemExtensionClasses: this.isPurchased ? "text-white" : null,
              showBefore: this.isPurchased && this.resetCode == "",
        ...
        // The heading
        title: {
          content: this.isPurchased ? "Purchase complete" : "Place your order",
          headingClasses: "font-weight-normal mb-0 text-center text-white",
          id: this.id + "-title",
          slot: "body-header",
          type: "h1"
        }
